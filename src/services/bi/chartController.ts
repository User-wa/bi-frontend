...
export async function genChartByAiAsyncUsingPost(
  ...
  return request<API.BaseResponseBiModelVO_>('/api/chart/genAsync', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** genChartByAiAsyncQueue POST /api/chart/genAsyncQe */
export async function genChartByAiAsyncQueueUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChartByAiAsyncQueueUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseBiModelVO_>('/api/chart/genAsyncQe', {
    method: 'POST',
    params: {
      ...params,
    },
...
export async function genChartByAiSyncUsingPost(
  ...
  return request<API.BaseResponseBiModelVO_>('/api/chart/genSync', {
    method: 'POST',
    params: {
      ...params,
    },
...
export async function listMyChartVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageChartVO_>('/api/chart/my/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
