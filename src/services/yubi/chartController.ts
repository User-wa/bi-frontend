...
/** genChartByAi POST /api/chart/genSync */
export async function genChartByAiUsingPOST(
  ...
  return request<API.BaseResponseyubiResponse_>('/api/chart/genSync', {
    method: 'POST',
    params: {
      ...params,
    },
...
export async function genChartByAiAsyncUsingPOST(
  ...
  return request<API.BaseResponseyubiResponse_>('/api/chart/genAsync', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** genChartByAiAsyncMq POST /api/chart/genAsyncQe */
export async function genChartByAiAsyncMqUsingPOST(
  ...
  return request<API.BaseResponseyubiResponse_>('/api/chart/genAsyncQe', {
    method: 'POST',
    params: {
      ...params,
    },
...
export async function genChartByIdUsingGET(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChartByIdUsingGETParams,
  options?: { [key: string]: any },
) {
