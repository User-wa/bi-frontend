...
import {addNotificationUsingPost} from "@/services/bi/notificationController";
// import {addNotificationUsingPost} from "@/services/backend/notificationController";
...
const handleAdd = async (fields: API.NotificationAddRequest) => {
  ...
  try {
    await addNotificationUsingPost(fields);
    hide();
